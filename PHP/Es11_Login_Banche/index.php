    ...
    <?php
        if($_SERVER["REQUEST_METHOD"]==="POST")//se la richiesta è in POST
        {
            if(isset($_POST["username"])&&isset($_POST["pwd"]))
            {
                ...
                //tempo, /, dominio, default, httponly
            ...
            <div class="col-sm-4">
                <form name="login">
                    ...
                    <div class="form-group">
                        <input type="button" class="btn-link form-control" style="text-align: left;padding-bottom: 0" value="Registrati" onclick="location.href='2_registrazione.php'">
